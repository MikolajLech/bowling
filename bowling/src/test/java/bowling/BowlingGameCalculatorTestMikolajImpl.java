...
public class BowlingGameCalculatorTestMikolajImpl {
	...
	public void shouldReturn300For101010101010101010101010() { // max points in game
		initCalc(10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10);
